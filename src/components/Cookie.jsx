...
export default function () {
    ...
    // },[])
  return (
    <motion.div initial={{opacity:0,y:200}} animate={{opacity:1,y:0}} transition={{duration:1,delay:4}} className={cookieAlreadyShown?'hidden':'bg-gray-900 flex flex-col items-center text-white py-6 gap-2 px-2 absolute fixed bottom-10 z-20 shadow-2xl mr-4'}>
