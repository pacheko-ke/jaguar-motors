...
export default function () {
  ...
  return (
    <div className={cookieAlreadyShown?'hidden':'bg-gray-900 flex flex-col items-center text-white py-6 gap-2 px-2 absolute fixed bottom-10 z-20 shadow-2xl mr-4'}>
        ...
        <button className='bg-black w-1/2 md:w-1/4 py-2'>Accept</button><button className='bg-transparent border-1 text-white border border-red-500 w-1/2 md:w-1/4 py-2'>Decline</button>
        </div>
    </div>
  )
}
