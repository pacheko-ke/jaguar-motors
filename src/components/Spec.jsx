...
export default function () {
    return (
        <div className='flex flex-col items-center text-white px-4 mt-2 gap-2'>
            ...
            <p className=''>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem optio aliquam nobis totam neque aliquid accusamus nesciunt quis cupiditate eveniet, praesentium, dolores a recusandae quasi, architecto dolore similique nostrum! Pariatur.
